...
export class Contracts {
  ...
  setProvider(
    ...
    this.treatBnbLp.options.address = addressMap["TreatBnbLp"]
    this.treatBnbLpPool.options.address = addressMap["TreatBnbLpPool"]
    this.cake.options.address = addressMap["Cake"]
    this.cakePool.options.address = addressMap["CakePool"]
